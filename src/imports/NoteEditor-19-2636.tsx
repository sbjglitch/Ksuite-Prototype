import svgPaths from "./svg-rk81ptflhv";
        ...
        <div className="bg-white relative rounded-bl-[12px] rounded-br-[12px] shrink-0 w-full" data-name="Note Editor">
          ...
          <div className="content-stretch flex flex-col gap-[8px] isolate items-start p-[8px] relative w-full">
            <div className="content-stretch flex items-center justify-between relative shrink-0 w-full z-[1]" data-name="Note Container">
              <div className="content-stretch flex gap-[8px] items-center justify-center pl-[8px] relative shrink-0" data-name="Icon Container">
                <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Icon Group">
                  ...
                  <p className="font-['Manrope:SemiBold',sans-serif] font-semibold leading-[22px] relative shrink-0 text-[#232f50] text-[16px] text-left whitespace-nowrap">Add Note</p>
                </div>
                <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Shortcut Container">
                  <div className="bg-[#f1f5f8] relative rounded-[6px] shrink-0" data-name="Shortcut Key Container">
                    <div className="content-stretch flex items-center justify-center overflow-clip px-[8px] py-[4px] relative rounded-[inherit]">
                      <p className="font-['Manrope:SemiBold',sans-serif] font-semibold leading-[16px] relative shrink-0 text-[#5c6e93] text-[12px] text-left whitespace-nowrap">Shift</p>
                    </div>
                    <div aria-hidden="true" className="absolute border border-[#e8eff4] border-solid inset-0 pointer-events-none rounded-[6px] shadow-[0px_1px_2px_0px_rgba(10,13,18,0.05)]" />
                  </div>
                  <div className="content-stretch flex items-center justify-center overflow-clip py-[4px] relative rounded-[4px] shrink-0" data-name="Shortcut Plus Container">
                    <p className="font-['Manrope:Regular',sans-serif] font-normal leading-[16px] relative shrink-0 text-[#5c6e93] text-[12px] text-left whitespace-nowrap">+</p>
                  </div>
                  <div className="bg-[#f1f5f8] relative rounded-[6px] shrink-0" data-name="Shortcut Key Container">
                    <div className="content-stretch flex items-center justify-center overflow-clip px-[8px] py-[4px] relative rounded-[inherit]">
                      <p className="font-['Manrope:SemiBold',sans-serif] font-semibold leading-[16px] relative shrink-0 text-[#5c6e93] text-[12px] text-left whitespace-nowrap">N</p>
                    </div>
                    <div aria-hidden="true" className="absolute border border-[#e8eff4] border-solid inset-0 pointer-events-none rounded-[6px] shadow-[0px_1px_2px_0px_rgba(10,13,18,0.05)]" />
                  </div>
                </div>
